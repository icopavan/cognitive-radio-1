...
%\author{Gitte Vanwinckelen~$^{1}$ Martijn Van Otterlo~$^{1}$  Kurt Driessens~$^{1}$ Sofie Pollin~$^{2}$ \\
% \\
%$^1$ Katholieke Universiteit Leuven ~~ E-mail~:~ \{gitte\}.{\{vanwinckelen\}@cs.kuleuven.be}\\
%$^2$ Interuniversity Micro-Electronics Center ~~E-mail~:~ pollins@imec.be \\}

\author{\IEEEauthorblockN{Gitte Vanwinckelen\IEEEauthorrefmark{1},  Martijn Van Otterlo\IEEEauthorrefmark{1},  Kurt Driessens\IEEEauthorrefmark{1} and  Sofie Pollin\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Department of Computer Science\\
Katholieke Universiteit Leuven, Belgium\\
Email:  \{gitte\}.\{vanwinckelen\}@cs.kuleuven.be}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Interuniversity Micro-Electronics Center,  Leuven, Belgium\\
